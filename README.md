...
- [Dictaste-Setup-0.1.32.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.32.zip) · live HUD word count · skip short reads · re-read last · clear history · skip short polish · data folder · reset hotkeys · word-count toast · import history · smart quotes · compact HUD · tray language · case modes · paste from history · history size · timed pause · persist pause · double-space period · max duration · silence auto-stop · paste delay · cancel · paste last · spoken punctuation · strip fillers · pause hotkeys · export settings · highlight-to-speak  
