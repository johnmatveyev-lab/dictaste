...
- [Dictaste-Setup-0.1.19.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.19.zip) · clipboard-only · polish selection · highlight-to-speak  
