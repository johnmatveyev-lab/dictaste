...
- [Dictaste-Setup-0.1.20.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.20.zip) · pause hotkeys · export settings · highlight-to-speak  
