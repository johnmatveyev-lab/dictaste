...
- [Dictaste-Setup-0.1.15.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.15.zip) · test voice · paste suffix · dictation language · highlight-to-speak  
