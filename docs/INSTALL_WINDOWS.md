...
## Preview zip (0.1.35 · continuous dictation + tray quick toggles)

1. Download [Dictaste-Setup-0.1.35.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.35.zip) or [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
