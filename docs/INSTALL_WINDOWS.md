...
## Preview zip (0.1.34 · sticky HUD + tray speech rate)

1. Download [Dictaste-Setup-0.1.34.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.34.zip) or [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
