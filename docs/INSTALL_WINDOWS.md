...
## Preview zip (0.1.70 · rotate lines last · whitespace last · columns last · truncate last · pad lines last · prefix/suffix lines last · split last · join lines last · filter lines last · stats last · reformat last + paste date/time + privacy + edit + read aloud + tray plan/usage)

1. Download [Dictaste-Setup-0.1.70.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.70.zip) or [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
