...
1. Download [Dictaste-Setup-0.1.10.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.6/Dictaste-Setup-0.1.10.zip) or use [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
