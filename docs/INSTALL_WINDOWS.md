...
## Preview zip (0.1.31 · re-read last + clear history)

1. Download [Dictaste-Setup-0.1.31.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.31.zip) or [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
