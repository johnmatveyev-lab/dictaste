...
## Preview zip (0.1.42 · pin history + edit + read aloud + tray plan/usage)

1. Download [Dictaste-Setup-0.1.42.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.42.zip) or [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
