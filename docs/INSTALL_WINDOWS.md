...
## Preview zip (0.1.24 · double-space period + max duration)

1. Download [Dictaste-Setup-0.1.24.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.24.zip) or [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
...
5. Double-space → period · max duration 90s safety · silence auto-stop · paste delay (Settings).
