...
## Preview zip (0.1.56 · reformat last + paste date/time + privacy + edit + read aloud + tray plan/usage)

1. Download [Dictaste-Setup-0.1.56.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.56.zip) or [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
