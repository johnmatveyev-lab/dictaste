...
## Preview zip (0.1.29 · word-count toast + import history)

1. Download [Dictaste-Setup-0.1.29.zip](https://github.com/johnmatveyev-lab/dictaste/releases/download/v0.1.4/Dictaste-Setup-0.1.29.zip) or [dictaste.vercel.app/download](https://dictaste.vercel.app/download).
